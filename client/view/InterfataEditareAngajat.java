...
public class InterfataEditareAngajat extends JFrame implements Observer {
    ...
    public InterfataEditareAngajat(){

        PersistentaElementFisier persistentaElementFisier = new PersistentaElementFisier();
        this.setTitle(persistentaElementFisier.vizualizare("editAngj",optiuneLimba));
